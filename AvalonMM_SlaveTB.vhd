...
architecture sim of AvalonMM_SlaveTB is
    ...
    signal avs_burst_count : std_logic_vector(3 downto 0);
    signal avs_burst_en    : std_logic;
    signal avs_waitrequest : std_logic;


    signal s_wr_cmd_data   : std_logic_vector(57 downto 0);
    signal s_wr_cmd_val    : std_logic;
    signal s_wr_cmd_full   : std_logic;
    signal b_wr_cmd_data   : std_logic_vector(57 downto 0);
    ...
    signal b_rd_cmd_data   : std_logic_vector(33 downto 0);
    signal b_rd_cmd_val    : std_logic;
    signal b_rd_cmd_full   : std_logic;
    signal s_rd_cmd_data   : std_logic_vector(33 downto 0);
...
begin
    ...
    FIFO_WR_CMD: entity work.FIFO 
        ...
        port map (
            ...
            wr_empty => open, wr_used => open, rd_full => open, rd_used => open
        );
